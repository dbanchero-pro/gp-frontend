...
export function ordenarYPaginar<T extends Record<string, any>>(
    items: T[], pagina: number, tamanoPagina: number, columnaOrden: keyof T, ordem: 'asc' | 'desc'): T[] {
...
function compararValores(orden: 'asc' | 'desc', aVal: any, bVal: any): number | undefined {
