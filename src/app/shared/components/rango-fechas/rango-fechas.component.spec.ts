...
describe('RangoFechasComponent', () => {
    ...
    beforeEach(async () => {
        await TestBed.configureTestingModule({
            declarations: [],
            imports: [ReactiveFormsModule, RangoFechasComponent],
        }).compileComponents();
    ...
    it('debería validar que fechaDesde sea anterior a fechaHasta', () => {
        const fechaDesde = new Date('2024-01-10')
            .toISOString()
            .substring(0, 10);
        const fechaHasta = new Date('2024-01-05')
            .toISOString()
            .substring(0, 10);
    ...
    it('debería marcar como inválido si requiredDesde está activado y no se completa', () => {
        ...
        expect(valid).toEqual({
            requiereFechaDesde: 'Fecha desde es obligatoria',
        });
    ...
    it('marca error si ambos campos requeridos faltan', () => {
        ...
        expect(res).toEqual({
            requiereFechaDesde: 'Fecha desde es obligatoria',
            requiereFechaHasta: 'La fecha hasta es obligatoria',
        });
        expect(component.errorFecha).toBe(
            'Las fechas desde y hasta no pueden estar vacías',
        );
    });
    ...
    it('cambioFechaDesde valida y emite el nuevo valor', () => {
        ...
        expect(component.validate).toHaveBeenCalledWith(
