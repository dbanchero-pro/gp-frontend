...
export class TipoDocumentoProveedorService {
  ...
  private readonly baseUrl = '/api/gestion-contratos/v1/tipos-documento-proveedor';
  ...
  obtenerTiposDocumentoProveedor(
    ...
    return this.gcRestService.get<PageModel<ITipoDocumentoProveedorDTO>>(`${this.baseUrl}/all`, params);
  }
  ...
  obtenerTodos(): Observable<ITipoDocumentoProveedorDTO[]> {
    ...
    return this.gcRestService
      .get<PageModel<ITipoDocumentoProveedorDTO>>(`${this.baseUrl}/all`, params)
