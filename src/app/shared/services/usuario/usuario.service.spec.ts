...
describe('UsuarioService', () => {
  ...
  it('debería obtener todos los usuarios con filtros', () => {
    ...
    service.obtenerTodosUsuarios(1, 15, 'nombre,desc', 'AR', 'DNI', '87654321').subscribe();
  ...
  it('debería obtener usuario por ID', () => {
    ...
    expect(gcRestSpy.get).toHaveBeenCalledWith('/api/gestion-contratos/v1/usuarios/juanito');
  });
