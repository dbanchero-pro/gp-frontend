...
export class UsuarioProveedorService {
    private readonly baseUrlProveedor =
    ...
    private crearParams(
        ...
        if (filtro?.idTipoDocumento)
            params = params.set('idTipoDocumento', filtro.idTipoDocumento);
        if (filtro?.nroDocumento)
            params = params.set('nroDocumento', filtro.nroDocumento);
    ...
    private exportarExcel(
        ...
        this.gcRestService
            .post<
                IArchivoDTO,
                any
            >(`${this.baseUrlProveedor}/${endpoint}`, params)
    ...
    obtenerTodosUsuariosProveedores(
        ...
        return this.gcRestService.get<PageModel<UsuarioProveedorDTO>>(
            `${this.baseUrlProveedor}/all`,
            params,
        );
    }
    ...
    obtenerTodosUsuariosProveedoresUsuarioOrganismos(
        ...
        const params = this.crearParams(filtro, page, size, sort);
        return this.gcRestService.get<PageModel<UsuarioProveedorDTO>>(
            `${this.baseUrlProveedor}/all-organismo`,
            params,
        );
    }
    ...
    exportarExcelUsuariosProveedor(filtro: {
        idPais?: string;
        idTipoDocumento?: string;
        nroDocumento?: string;
    }): void {
    ...
    exportarExcelUsuariosProveedorUsuarioOrganismo(filtro: {
        idPais?: string;
        idTipoDocumento?: string;
        nroDocumento?: string;
    }): void {
    ...
    actualizarUsuarioProveedor(
        ...
        const url = `${this.baseUrlProveedor}/${idUsuario}/${paisDocumentoProveedor}/${tipoDocumentoProveedor}/${nroDocumentoProveedor}`;
        return this.gcRestService.put<UsuarioProveedorDTO, UsuarioProveedorDTO>(
            url,
            dto,
        );
    }
