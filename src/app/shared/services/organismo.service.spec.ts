...
describe('OrganismoService', () => {
    ...
    it('debería obtener incisos', () => {
        ...
        expect(gcRestSpy.get).toHaveBeenCalledWith(
            '/api/gestion-contratos/v1/incisos/all-sorted?',
        );
    });
    ...
    it('debería obtener incisos con usuario', () => {
        ...
        expect(gcRestSpy.get).toHaveBeenCalledWith(
            '/api/gestion-contratos/v1/incisos/all-sorted?idUsuarioSeleccionado=99',
        );
    });
    ...
    it('debería obtener incisos incluyendo administrativas', () => {
        ...
        expect(gcRestSpy.get).toHaveBeenCalledWith(
            '/api/gestion-contratos/v1/incisos/all-sorted?incluirAdministrativas=true&',
        );
    });
    ...
    it('debería obtener incisos incluyendo administrativas para un usuario', () => {
        ...
        expect(gcRestSpy.get).toHaveBeenCalledWith(
            '/api/gestion-contratos/v1/incisos/all-sorted?incluirAdministrativas=true&idUsuarioSeleccionado=42',
        );
    });
    ...
    it('debería obtener unidades ejecutoras', () => {
        ...
        expect(gcRestSpy.get).toHaveBeenCalledWith(
            '/api/gestion-contratos/v1/incisos/1/unidades-ejecutoras/all?',
        );
    });
    ...
    it('debería obtener unidades ejecutoras con usuario', () => {
        ...
        expect(gcRestSpy.get).toHaveBeenCalledWith(
            '/api/gestion-contratos/v1/incisos/1/unidades-ejecutoras/all?idUsuarioSeleccionado=55',
        );
    });
    ...
    it('debería obtener unidades ejecutoras con administrativas', () => {
        ...
        expect(gcRestSpy.get).toHaveBeenCalledWith(
            '/api/gestion-contratos/v1/incisos/3/unidades-ejecutoras/all?incluirAdministrativas=true&',
        );
    });
    ...
    it('debería obtener unidades ejecutoras con administrativas y usuario', () => {
        ...
        expect(gcRestSpy.get).toHaveBeenCalledWith(
            '/api/gestion-contratos/v1/incisos/3/unidades-ejecutoras/all?incluirAdministrativas=true&idUsuarioSeleccionado=77',
        );
    });
    ...
    it('debería obtener unidades de compra', () => {
        ...
        expect(gcRestSpy.get).toHaveBeenCalledWith(
            '/api/gestion-contratos/v1/unidades-ejecutoras/1/2/unidades-compras/all?',
        );
    });
    ...
    it('debería obtener unidades de compra con usuario', () => {
        ...
        expect(gcRestSpy.get).toHaveBeenCalledWith(
            '/api/gestion-contratos/v1/unidades-ejecutoras/1/2/unidades-compras/all?idUsuarioSeleccionado=10',
        );
    });
    ...
    it('debería obtener unidades de compra con administrativas', () => {
        ...
        expect(gcRestSpy.get).toHaveBeenCalledWith(
            '/api/gestion-contratos/v1/unidades-ejecutoras/5/9/unidades-compras/all?incluirAdministrativas=true&',
        );
    });
    ...
    it('debería obtener unidades de compra con administrativas y usuario', () => {
        ...
        expect(gcRestSpy.get).toHaveBeenCalledWith(
            '/api/gestion-contratos/v1/unidades-ejecutoras/5/9/unidades-compras/all?incluirAdministrativas=true&idUsuarioSeleccionado=10',
        );
    });
    ...
    it('debería obtener unidades ejecutoras para OC de proveedor', () => {
        ...
        expect(gcRestSpy.get).toHaveBeenCalledWith(
            '/api/gestion-contratos/v1/incisos/8/unidades-ejecutoras/all-oc-proveedor',
        );
    });
    ...
    it('debería obtener unidades de compra para OC de proveedor', () => {
        ...
        expect(gcRestSpy.get).toHaveBeenCalledWith(
            '/api/gestion-contratos/v1/unidades-ejecutoras/4/6/unidades-compras/all-oc-proveedor',
        );
    });
    ...
    it('debería obtener unidades de compra del usuario', () => {
        ...
        expect(gcRestSpy.get).toHaveBeenCalledWith(
            '/api/gestion-contratos/v1/unidades-compra/all?idUsuario=101',
        );
    });
    ...
    it('debería construir parámetros combinando administrativa y usuario', () => {
        ...
        expect(result).toBe(
            '?incluirAdministrativas=true&idUsuarioSeleccionado=33',
        );
    });
