...
describe('ActualizarService', () => {
  ...
  it('otros mensajes y guardar por defecto', () => {
    ...
    expect((service as any).mensajeTemporal[1]).toBe(TipoMensajeEnum.success);
    service.emitirMensajeTemporalSiExiste();
    expect(service.mensaje$.value).toEqual([['ok'], TipoMensajeEnum.success]);
    service.emitirMensajeTemporalSiExiste();
