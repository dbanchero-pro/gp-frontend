...
class MockComponent { canDeactivate() { return false; } }
...
describe('DeactivateGuard', () => {
  ...
  beforeEach(() => {
    ...
    TestBed.configureTestingModule({
      providers: [DeactivateGuard, { provide: ActualizarService, useValue: service }]
    });
  ...
  it('solicita confirmación si el componente no puede desactivarse', async () => {
    let confirmCb: () => void = () => {};
    service.confirmar.and.callFake((_m: any, ok: () => void) => { confirmCb = ok; });
    const promise = guard.canDeactivate(new MockComponent() as any, null as any, null as any);
    confirmCb();
