...
export class DocumentoRepositorioService {
        ...
        const documentosMock: DocumentoRepositorioDTO[] = [
            {
                ...
                descripcionDocumento:
                    'Logo oficial de la institución en formato vectorial',
            ...
            },
            {
                ...
                descripcionDocumento:
                    'Formulario estándar para solicitudes de compra',
                tipoArchivo: TipoArchivoRepositorio.FORMULARIO,
                archivo: new ArchivoDTO(
                    2,
                    'formulario-compras.docx',
                    'application/vnd.openxmlformats-officedocument.wordprocessingml.document',
                    'base64content',
                    false,
                    false,
            ...
            },
            {
                ...
                descripcionDocumento:
                    'Plantilla para evaluar el desempeño del personal',
                tipoArchivo: TipoArchivoRepositorio.FORMULARIO,
                archivo: new ArchivoDTO(
                    3,
                    'evaluacion-desempeno.xlsx',
                    'application/vnd.openxmlformats-officedocument.spreadsheetml.sheet',
                    'base64content',
                    false,
                    false,
            ...
            },
            {
                ...
                descripcionDocumento:
                    'Logo oficial del Ministerio del Interior',
                tipoArchivo: TipoArchivoRepositorio.LOGO,
                archivo: new ArchivoDTO(
                    4,
                    'logo-ministerio.pdf',
            ...
            },
            {
                ...
                descripcionDocumento:
                    'Documento con procedimientos administrativos internos',
                tipoArchivo: TipoArchivoRepositorio.OTRO,
                archivo: new ArchivoDTO(
                    5,
                    'manual-procedimientos.pdf',
                    'application/pdf',
                    'base64content',
                    false,
                    false,
            ...
            },
            {
                ...
                descripcionDocumento:
                    'Formulario para registrar inventario de materiales',
                tipoArchivo: TipoArchivoRepositorio.FORMULARIO,
                archivo: new ArchivoDTO(
                    6,
                    'formulario-inventario.xls',
                    'application/vnd.ms-excel',
                    'base64content',
                    false,
                    false,
            ...
            },
            {
                ...
                descripcionDocumento:
                    'Plantilla Excel para elaborar presupuestos anuales',
                tipoArchivo: TipoArchivoRepositorio.FORMULARIO,
                archivo: new ArchivoDTO(
                    7,
                    'presupuesto-anual.xlsx',
                    'application/vnd.openxmlformats-officedocument.spreadsheetml.sheet',
                    'base64content',
                    false,
                    false,
            ...
            },
            {
                ...
                descripcionDocumento:
                    'Documento con instrucciones para procesar pagos',
                tipoArchivo: TipoArchivoRepositorio.OTRO,
                archivo: new ArchivoDTO(
                    9,
                    'instructivo-pagos.doc',
                    'application/msword',
                    'base64content',
                    false,
                    false,
            ...
            },
            {
                ...
                descripcionDocumento:
                    'Formulario para inscripción de estudiantes',
                tipoArchivo: TipoArchivoRepositorio.FORMULARIO,
                archivo: new ArchivoDTO(
                    10,
                    'inscripcion-estudiantes.docx',
                    'application/vnd.openxmlformats-officedocument.wordprocessingml.document',
                    'base64content',
                    false,
                    false,
            ...
            },
            {
                ...
                descripcionDocumento:
                    'Planificación de obras de infraestructura educativa',
                tipoArchivo: TipoArchivoRepositorio.OTRO,
                archivo: new ArchivoDTO(
                    12,
                    'plan-obras-2024.xlsx',
                    'application/vnd.openxmlformats-officedocument.spreadsheetml.sheet',
                    'base64content',
                    false,
                    false,
            ...
            },
            {
                ...
                descripcionDocumento:
                    'Formulario estándar para historias clínicas',
                tipoArchivo: TipoArchivoRepositorio.FORMULARIO,
                archivo: new ArchivoDTO(
                    13,
            ...
            },
            {
                ...
                descripcionDocumento:
                    'Documento con protocolos de almacenamiento y distribución',
                tipoArchivo: TipoArchivoRepositorio.OTRO,
                archivo: new ArchivoDTO(
                    15,
                    'protocolo-medicamentos.pdf',
                    'application/pdf',
                    'base64content',
                    false,
                    false,
    ...
    obtenerTodos(
        ...
        if (filtro.idInciso) {
            documentosFiltrados = documentosFiltrados.filter(
                (doc) => doc.idInciso === filtro.idInciso,
            );
        }
        if (filtro.idUnidadEjecutora) {
            documentosFiltrados = documentosFiltrados.filter(
                (doc) => doc.idUnidadEjecutora === filtro.idUnidadEjecutora,
            );
        }
        ...
        if (filtro.tipoArchivo) {
            documentosFiltrados = documentosFiltrados.filter(
                (doc) => doc.tipoArchivo === filtro.tipoArchivo,
            );
        }
    ...
    crear(
        documento: DocumentoRepositorioDTO,
    ): Observable<DocumentoRepositorioDTO> {
        // Validar archivo
    ...
    validarArchivo(archivo: IArchivoDTO): { valido: boolean; mensaje: string } {
        ...
        if (
            archivo.mimeType &&
            !this.TIPOS_PERMITIDOS.includes(archivo.mimeType)
        ) {
            return {
                valido: false,
                mensaje:
