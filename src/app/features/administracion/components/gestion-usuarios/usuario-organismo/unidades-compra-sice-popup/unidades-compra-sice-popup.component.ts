...
export class UnidadesCompraSicePopupComponent
    ...
    implements OnInit
{
    ...
    override listaOrden: IColumnaOrden[] = [
        ...
        {
            id: 'idInciso,idUnidadEjecutora,idUnidadCompra',
            nombre: 'Unidad compra',
        },
    ];

    override ordenInicial: 'asc' | 'desc' = 'asc';
    override columnaOrdenInicial: string =
        'idInciso,idUnidadEjecutora,idUnidadCompra';
    ...
    override buscar(): void {
        this.organismoService
            .obtenerUCUsuarioOrganismo(this.usuario.id)
            .subscribe((datos: UnidadCompraDTO[]) => {
                this.todasUC = datos;
                ...
                if (this.todasUC.length > 0) {
                    this.unidadesCompra = ordenarMultipleYPaginar(
                        this.todasUC,
                        this.parametros.pagina,
                        this.parametros.tamanoPagina,
                        this.parametros.sort.split(','),
