...
describe('ConsultaUsuariosRolesItemsComponent', () => {
    ...
    const compraSiceServiceStub = jasmine.createSpyObj('CompraSiceService', ['obtenerListaItemsCompra', 'obtenerCompraPorId']);
    ...
    const usuarioRolesServiceStub = jasmine.createSpyObj('UsuarioRolesService', ['agregarRolPorItem']);
