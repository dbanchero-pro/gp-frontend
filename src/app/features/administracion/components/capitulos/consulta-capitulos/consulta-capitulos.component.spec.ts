...
describe('ConsultaCapitulosComponent', () => {
  ...
  const capituloServiceStub = jasmine.createSpyObj('CapituloService', ['buscarCapitulos', 'eliminarCapitulo']);
  capituloServiceStub.buscarCapitulos.and.returnValue(of([]));
  capituloServiceStub.eliminarCapitulo.and.returnValue(of({ exitoso: true, mensaje: '' }));
