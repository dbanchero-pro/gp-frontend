...
describe('ConsultaRepositorioArchivosComponent', () => {
    ...
    const documentoServiceStub = jasmine.createSpyObj(
        ...
        ['obtenerTiposArchivo', 'obtenerTodos', 'descargar', 'eliminar'],
    );
    documentoServiceStub.obtenerTiposArchivo.and.returnValue([]);
    documentoServiceStub.obtenerTodos.and.returnValue(
    ...
    const archivoServiceStub = jasmine.createSpyObj('ArchivoService', [
        'descargar',
    ]);
