...
export class AgregarModificarRepositorioArchivoComponent
    ...
    implements OnInit, CanComponentDeactivate
{
    ...
    canDeactivate(): boolean {
        ...
        return (
            !this.form.dirty ||
            confirm('Tiene cambios sin guardar. ¿Está seguro que desea salir?')
        );
    }
    ...
    private inicializarFormulario(): void {
        const archivoValidators = this.esModificacion
            ? []
            : [Validators.required];

        this.form = this.fb.nonNullable.group({
            organismo: this.fb.control<IFiltroOrganismoDTO | null>(
                null,
                Validators.required,
            ),
