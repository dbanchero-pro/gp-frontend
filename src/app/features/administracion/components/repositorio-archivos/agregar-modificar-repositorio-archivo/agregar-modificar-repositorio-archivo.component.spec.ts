...
describe('AgregarModificarRepositorioArchivoComponent', () => {
    ...
    const documentoServiceStub = jasmine.createSpyObj(
        'DocumentoRepositorioService',
        ['obtenerPorId', 'crear', 'actualizar'],
    );
    ...
    beforeEach(async () => {
        await TestBed.configureTestingModule({
            ...
            providers: [
                ...
                {
                    provide: DocumentoRepositorioService,
                    useValue: documentoServiceStub,
                },
            ],
    ...
    it('usa el archivo existente cuando se modifica sin seleccionar un archivo nuevo', () => {
        const archivoExistente = new ArchivoDTO(
            1,
            'manual.pdf',
            'application/pdf',
            'base64',
        ...
        const documentoGuardado =
            documentoServiceStub.actualizar.calls.mostRecent()
                .args[0] as DocumentoRepositorioDTO;
    ...
    it('muestra error si se intenta guardar sin archivo y sin documento existente', () => {
        const mensajeSpy = spyOn(
            component['actualizarService'],
            'mensajeError',
        );
        component.esModificacion = true;
