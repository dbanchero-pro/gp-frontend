...
describe('ConsultaCamposReglasComponent', () => {
    ...
    const campoServiceStub = jasmine.createSpyObj('CampoService', [
        'obtenerTiposFuente',
    ...
    campoServiceStub.obtenerTodosPaginado.and.returnValue(
    ...
    const operadorHelperStub = jasmine.createSpyObj('OperadorHelperService', [
    ...
    beforeEach(async () => {
        await TestBed.configureTestingModule({
            declarations: [],
            imports: [ReactiveFormsModule, ConsultaCamposReglasComponent],
            providers: [
                ...
                {
                    provide: OperadorHelperService,
                    useValue: operadorHelperStub,
                },
