...
import { AuditoriaEntregaComponent } from './auditoria-entrega.component';
...
class AuditoriaEntregaServiceStub {
...
describe('AuditoriaEntregaComponent', () => {
  let component: AuditoriaEntregaComponent;

  beforeEach(() => {
    TestBed.configureTestingModule({
      declarations: [AuditoriaEntregaComponent, FiltroItemsStub],
      ...
      providers: [
        ...
        { provide: AuditoriaEntregaService, useClass: AuditoriaEntregaServiceStub },
    ...
    TestBed.overrideTemplate(AuditoriaEntregaComponent, '');

    const fixture = TestBed.createComponent(AuditoriaEntregaComponent);
  ...
  it('debe buscar auditorías cuando el formulario es válido', () => {
    const auditoriaSrv = TestBed.inject(AuditoriaEntregaService) as unknown as AuditoriaEntregaServiceStub;
