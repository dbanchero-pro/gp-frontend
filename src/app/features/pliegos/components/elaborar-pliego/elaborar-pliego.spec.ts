...
describe('ElaborarPliegoComponent', () => {
    ...
    beforeEach(() => {
        ...
        elaborarPliegoServiceSpy = jasmine.createSpyObj<ElaborarPliegoService>(
            'ElaborarPliegoService',
            [
                'crearPliegoDemo',
    ...
    it('debe inicializar datos desde el servicio en el constructor', () => {
        expect(
            elaborarPliegoServiceSpy.obtenerUsuariosAsignadosMock,
        ).toHaveBeenCalled();
        expect(
            elaborarPliegoServiceSpy.obtenerHistorialTareasMock,
        ).toHaveBeenCalled();
        expect(
            elaborarPliegoServiceSpy.obtenerSeccionesMock,
        ).toHaveBeenCalled();
