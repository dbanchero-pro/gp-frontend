...
export class ElaborarPliegoComponent implements OnInit, CanComponentDeactivate {
  ...
  constructor(
    ...
    this.usuariosAsignados = this.elaborarPliegoService.obtenerUsuariosAsignadosMock();
    this.historialTareas = this.elaborarPliegoService.obtenerHistorialTareasMock();
